 ...
 *
 * Esta gramática é usada no T3 para construir a árvore sintática que será
 * percorrida pelo visitante semântico. As regras léxicas preservam os erros do
 * T1 e as regras sintáticas preservam o comportamento do T2.
 */
